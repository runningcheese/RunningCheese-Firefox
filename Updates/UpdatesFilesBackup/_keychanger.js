...
keys['Alt+['] =  'document.getElementById("nav-bar-overflow-button").click();  setTimeout(function(){document.getElementById("popupwindow_ettoolong-browser-action").click();}, 100);';  //小窗模式
