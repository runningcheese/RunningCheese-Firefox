...
//Shift 组合键
// keys['Shift+F1'] =""; // 侧边栏列出打开标签
keys['Shift+F2'] =function() {var listenOpen = {
...
document.getElementById('menuitem_inspector').click();
var tId = setTimeout(function() {
	Services.ww.unregisterNotification(listenOpen);
}, 5000);}; // 打开工具箱
keys['Shift+F3'] =function() {var listenOpen = {
	observe: function(aSubject, aTopic, aData) {
		if (aTopic != 'domwindowopened') return;
		var newWin = aSubject;
		newWin.addEventListener('load', function onLoad() {
