...
(function() {
	...
	(function() {
		var UndoClosedTabs = document.getElementById('stop-reload-button');
		if (!UndoClosedTabs) return;
...
location.href.startsWith('chrome://browser/content/browser.x') && gBrowser.addTabsProgressListener({
