	...
	CustomizableUI.createWidget({
		...
		onClick : function (event) {
			...
			case 0:
				// 左键：选择用户代理
  (function(){
       window.open("moz-extension://7171b2f2-e3cc-4031-b9ab-a9a0273ab809/manage.html","Header Editor","resizable,scrollbars,status,title","centerscreen").resizeTo(800, 550);
    })();
				break;
			case 1:
				break;
