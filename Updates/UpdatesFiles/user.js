...
# 2019-11-27 版本 by runningcheee


//控制内存使用
pref("browser.sessionhistory.max_total_viewers", 8);//设置标签页面缓存的数量
...
pref("browser.urlbar.maxRichResults",12); //地址栏里的历史记录数量
...
user_pref("media.videocontrols.picture-in-picture.enabled", true);//开启画中画功能
user_pref("media.videocontrols.picture-in-picture.video-toggle.enabled", true);//开启画中画功能
...
pref("extensions.htmlaboutaddons.discover.enabled",false); //去除附加管理器页面的推荐扩展
pref("extensions.htmlaboutaddons.recommendations.enabled",false); //去除附加管理器页面的推荐扩展
//pref("gfx.direct2d.disabled",false); // 开启direct2d，用于硬件加速，默认即是这个值
