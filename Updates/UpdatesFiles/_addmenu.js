...
oncommand : function () {
document.getElementById("nav-bar-overflow-button").click();  setTimeout(function(){document.getElementById("popupwindow_ettoolong-browser-action").click();}, 100);
setTimeout(function(){
(function ()
...
{
					label: "生成链接二维码",
          oncommand: "gBrowser.addTab('https://api.qrserver.com/v1/create-qr-code/?size=300x300&data='+ decodeURIComponent(gContextMenu.linkURL));",
		  image:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAASklEQVQ4jWNgoBL4jwUzINH41GAoROajG4BTD7oGfAZgk8NrOlYN2AzA5b//RKihHGAznRhMWxcwMGCGxeBIB3gNwMYfIumAbAAAQZVapq3RMcUAAAAASUVORK5CYII="
				},
{	
...
{},
{
    label: "谷歌弹窗翻译",
    tooltiptext: '注意：需科学上网',
    oncommand: function() {gBrowser.addTab('https://translate.google.com/translate?u='+decodeURIComponent(gBrowser.currentURI.spec)+'&hl=zh-CN&ie='+'&sl=auto&tl=zh-CN');},
    image: "data:image/png;base64,"
},{
    label: "必应弹窗翻译",
...
{
    label: "百度弹窗翻译",
  oncommand: function() {gBrowser.addTab('http://fanyi.baidu.com/transpage?query='+ decodeURIComponent(gBrowser.currentURI.spec)+'&from=auto&to=zh&source=url&render=1');},
...
{
    label: "分享当前页面",
    url: "javascript:var%20d=document;var%20b=d.body;if(b&&!document.xmlVersion){if(!d.getElementById('bsBox')){void(y=document.createElement('script'));void(y.src='http://static.bshare.cn/b/bookmark.js#lang=zh');void(b.appendChild(y));}else{bShare.show();}}",
	...
	},
{
   ...
   oncommand: function() {
        var url = encodeURIComponent(gContextMenu.mediaURL || gContextMenu.imageURL || gContextMenu.bgImageURL);
        gBrowser.addTab('https://www.tineye.com/search?url=' + url);
    }
	},
{
		label: 'Yandex',
   ...
   oncommand: function() {
        var url = encodeURIComponent(gContextMenu.mediaURL || gContextMenu.imageURL || gContextMenu.bgImageURL);
            gBrowser.addTab('https://yandex.com/images/search?source=collections&&url=' + url +'&rpt=imageview');
    }
	},
{
    label: "使用全部",
	...
	var menu = PageMenu({ condition:'image', id:'context-searchimage',accesskey:'S',insertAfter:'context-viewimage', icon:'image', 	image:"data:image/png;base64,",onpopupshowing: syncHidden});
	menu(items);
	items.forEach(function(it){
		if (it.command)
...
new function () {
	...
	{label:"复制当前标签MD代码",oncommand: function() {(function(){
...
{label:"复制所有标签标MD代码",oncommand: function() {(function() {
						var gClipboardHelper = Components.classes['@mozilla.org/widget/clipboardhelper;1'].getService(Components.interfaces.nsIClipboardHelper);
