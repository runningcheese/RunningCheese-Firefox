...
pref("browser.sessionhistory.max_entries", 25);//设置标签前进/后退历史记录缓存数量
pref("config.trim_on_minimize", true);//最小化时释放物理内存
//pref("toolkit.cosmeticAnimations.enabled", false);//关闭标签动画 (老机器可以开启)
...
pref("browser.pagethumbnails.capturing_disabled", true);//禁止生成略缩图
